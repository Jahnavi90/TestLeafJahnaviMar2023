...
public class SnapDeal {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//String name = cd.findElement(By.xpath("//div[text()[normalize-space()='Quick View']]/following::p")).getText();
		//System.out.println(name);
		//String priceDiscount = cd.findElement(By.xpath("(//div[contains(@class,'product-price')])[1]")).getText();
		String currency = cd.findElement(By.xpath("//div[contains(@class,'product-price pdp-e-i-PAY-l')]")).getText();
		...
		//File scrnShot = cd.getScreenshotAs(OutputType.FILE);
		//FileUtils.copyFile(scrnShot, new File("D:\Test Leaf\Selenium_Mar23\src\main\java\day11\assignments"));
		cd.close();
	}
}
