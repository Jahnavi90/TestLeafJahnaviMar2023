package marathon2TestCasesVanilla;
...
8. Verify Whether Individual is Deleted using Individual last name"
		...
		driver.findElement(By.id("username")).sendKeys("jahnavi90@tcs.com");
		driver.findElement(By.id("password")).sendKeys("SaiBaba@143$");
		...
		driver.findElement(By.xpath("//input[@class='slds-input']")).sendKeys("Jahnavi",Keys.ENTER);
		Thread.sleep(3000);
